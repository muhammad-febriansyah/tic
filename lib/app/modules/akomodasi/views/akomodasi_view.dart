...
class AkomodasiView extends GetView<AkomodasiController> {
  final controller = Get.put(AkomodasiController());
  @override
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: Container(
          ...
          height: Get.height,
          color: kWhiteclr,
          child: GetBuilder<AkomodasiController>(
            builder: (controller) {
