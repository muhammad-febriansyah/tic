...
class MoneychangerView extends GetView<MoneychangerController> {
  final controller = Get.put(MoneychangerController());
  @override
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: Container(
          ...
          child: GetBuilder<MoneychangerController>(
            builder: (controller) {
