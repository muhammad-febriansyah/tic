...
import 'package:tic/app/modules/detailevent/views/infoevent_view.dart';
import 'package:tic/app/modules/detailevent/views/mapevent_view.dart';
    ...
    return DefaultTabController(
      ...
      child: Scaffold(
        ...
        body: TabBarView(
          ...
          children: [InfoeventView(), MapeventView()],
        ),
      ),
    );
  }
